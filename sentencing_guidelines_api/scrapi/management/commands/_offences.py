...
class OffenceScraper:
    ...
    def get_list_of_offences(self):
        offences = []
        soup = BeautifulSoup(self.get_list_of_offences_markup(), "html.parser")
        ...
        for offence in list_of_offences:
            ...
            offences.append(offence_name)

        return offences

    def get_list_of_offences_markup(self):
